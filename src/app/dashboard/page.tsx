      ...
      <Card className="mt-8 overflow-hidden">
        ...
        <CardContent>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {[
                  { src: "https://placehold.co/600x400.png", alt: "Modern Living Room", hint: "living room" },
                  { src: "https://placehold.co/600x400.png", alt: "Cozy Bedroom", hint: "bedroom" },
                  { src: "https://placehold.co/600x400.png", alt: "Bright Kitchen", hint: "kitchen" }
                ].map((img, idx) => (
                    <div key={idx} className="rounded-lg overflow-hidden shadow-md aspect-video_ relative group">
                        <Image 
                            src={img.src} 
                            alt={img.alt} 
                            width={600} 
